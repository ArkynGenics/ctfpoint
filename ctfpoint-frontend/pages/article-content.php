...
<div class="container">
    <div class="card text-center">
        ...
        <div class="card-body">
            <h5 class="card-title">Get to know HTTP Smuggling</h5>
            <p class="card-text">Lorem, ipsum dolor sit amet consectetur adipisicing elit. Veritatis amet a repellat ex sint consectetur dolor quos cumque, quae maiores delectus excepturi sequi dolore possimus repellendus, molestias mollitia. Amet, quaerat.</p>
        </div>
    </div>
</div>
</section>
