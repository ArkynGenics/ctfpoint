    ...
    <div class="card text-center">
        <div class="card-header">
            <ul class="nav nav-tabs card-header-tabs">
                ...
                <li class="nav-item">
                    <a class="nav-link active" aria-current="true" href="#" style="color:black;">Edit mode</a>
                </li>
            </ul>
        </div>
        <div class="card-body">
            <h5 class="card-title">Hack The Box: Phonebook</h5>
            <p class="card-text">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Labore ea commodi dolores possimus asperiores nulla? Vero, ea libero? Molestias ad quam rem eum? Dolore recusandae odio illo qui. Nesciunt, temporibus.</p>
        </div>
    </div>
</div>
</section>
